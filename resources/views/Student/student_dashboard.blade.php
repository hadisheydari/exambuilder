...
<div class="min-h-screen flex">
    ...
    <div>
        ...
        <aside class="w-64 bg-blue-800 text-white flex flex-col shadow-lg h-full">
            <div class="p-6 text-center border-b border-blue-700">
                <h1 class="text-2xl font-bold">Management Panel</h1>
            </div>
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="#" class="block px-4 py-2 rounded-lg hover:bg-blue-600 transition">1Dashboard</a>
                <a href="#" class="block px-4 py-2 rounded-lg hover:bg-blue-600 transition">1Users</a>
                <a href="#" class="block px-4 py-2 rounded-lg hover:bg-blue-600 transition">1Reports</a>
                <a href="#" class="block px-4 py-2 rounded-lg hover:bg-blue-600 transition">1Settings</a>
            </nav>
